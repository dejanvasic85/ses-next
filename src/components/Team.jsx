  ...
  return (
    <div className="bg-white py-6 sm:py-8 lg:py-12">
      <div className="max-w-screen-xl px-4 md:px-8 mx-auto">
        ...
        <div className="flex flex-col flex-wrap justify-center lg:flex-row gap-4 lg:gap-8">
          {members.map(({ avatar, fullName, role }) => (
            <div className="flex flex-col items-center w-80 bg-slate-100 rounded-lg p-4 lg:p-8">
