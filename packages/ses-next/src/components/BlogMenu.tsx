    ...
    <header>
      <div className="flex items-center gap-3">
        <Link href="/blog" className="inline-block hover:opacity-80">
          <h1 className="font-title text-base-content text-2xl font-extrabold">SES Melbourne Blog</h1>
        </Link>
        <div className="tooltip tooltip-right" data-tip="RSS">
          <a href="/rss.xml" className="hover:text-warning" aria-label="RSS Feed">
